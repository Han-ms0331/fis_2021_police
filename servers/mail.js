		...
		let info = await transporter.sendMail({
			...
			attachments: [
				...
				},
				{
					...
					path: '221년 지문등 사전등록 현장방문 사업추진 관련 협조 요청.pdf',
				},
			],
		});
